...
#define COMCERTO_GPIO_32_OUTPUT_REG                     (COMCERTO_APB_GPIO_BASE + 0xD0)
#define COMCERTO_GPIO_32_OE_REG                         (COMCERTO_APB_GPIO_BASE + 0xD4)
#define COMCERTO_GPIO_32_INPUT_REG                      (COMCERTO_APB_GPIO_BASE + 0xD8)
#define COMCERTO_GPIO_32_PIN_SELECT_REG                 (COMCERTO_APB_GPIO_BASE + 0xDC)
...
// Western Digital: Add missing gpio defs...
